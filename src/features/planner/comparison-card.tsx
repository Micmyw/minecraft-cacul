import { AlertIcon, GemIcon } from "@/components/icons";
...
export function ComparisonCard({
  ...
  if (baseline === null || levelsSaved === null) {
    return (
      <div className="comparison-card warning-card">
        <p><AlertIcon size={18} />The sequential order reaches Too Expensive.</p>
      </div>
    );
  }
  ...
  return (
    <div className="comparison-card">
      <GemIcon className="comparison-icon" size={25} />
      <dl>
