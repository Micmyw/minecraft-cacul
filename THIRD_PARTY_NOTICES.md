...
- Project: https://github.com/iamcal/enchant-order
- Pinned commit: `380c9f8639e48c6b1a668b68b6f3228753fe00fe`
- Copyright: Copyright (c) 2021 Cal Henderson
- License: MIT, reproduced in `licenses/iamcal-enchant-order-MIT.txt`
...
"levels" mode. AnvilPilot follows its own documented objective of minimizing
the sum of displayed anvil level costs; comparison fixtures record this
difference where it changes the selected order.
